...
public class MoveEndEffector extends Command {
    ...
    public static final double L4_HEIGHT = Units.inchesToMeters(60.0);
    ...
    public static final double BACK_INTAKE_HEIGHT = Units.inchesToMeters(4.5);
    public static final double BACK_INTAKE_ANGLE = 120.0;
    
    public static final double L2_ALGAE_HEIGHT= Units.inchesToMeters(2);
