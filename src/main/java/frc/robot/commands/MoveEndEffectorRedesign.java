...
public class MoveEndEffectorRedesign extends Command {
    ...
    public MoveEndEffectorRedesign(Constants.Position position, Elevator elevator, EndEffectorPivot pivot) {
        this(position, elevator, pivot, DEFAULT_TIMEOUT);
    }

    public MoveEndEffectorRedesign(Constants.Position position, Elevator elevator, EndEffectorPivot pivot, double timeout) {
        m_pivot = pivot;
        m_elevator = elevator;
        m_position = position;
