...
import frc.robot.commands.redesign.RedesignReefTractorBeamWithDirectPath;
...
public class CompRobotContainer extends RobotContainer {
    ...
    private void configureBindings() {
        ...
        m_driverController.rightBumper().onTrue(new DeferredCommand(new RedesignReefTractorBeamWithDirectPath(m_driveTrain, false, m_coralEffector::hasCoral), Set.of(m_driveTrain)));
        m_driverController.leftBumper().onTrue(new DeferredCommand(new RedesignReefTractorBeamWithDirectPath(m_driveTrain, true, m_coralEffector::hasCoral), Set.of(m_driveTrain)));
        ...
        m_farm.button(12).onTrue(new DeferredCommand(new RedesignReefTractorBeamWithDirectPath(m_driveTrain, false, ()->false), Set.of(m_driveTrain)));
