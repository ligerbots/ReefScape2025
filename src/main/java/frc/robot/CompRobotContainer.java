...
public class CompRobotContainer extends RobotContainer {
    ...
    private void configureAutos() {
        ...
        Pose2d[] reefPoints3 = {FieldConstants.REEF_I, FieldConstants.REEF_K, FieldConstants.REEF_L, FieldConstants.REEF_A};
        m_chosenReefPoints.addOption("IKLA  (aka FDCB)", reefPoints3);

        Pose2d[] reefPoints4 = { FieldConstants.REEF_H };
        m_chosenReefPoints.addOption("H only  (aka G only) Center auto", reefPoints4);
